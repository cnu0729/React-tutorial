        ...
        <UserContext.Provider value={ {userList, setUserList} }>
            ...
            <div>
                ...
                {/* userList 초기에 저장된 유저목록을 보여주는 것
                    ...
                    저장이 된 모든 값을 index = 번호를 매겨 순서대로 기ㅗㄺ
                ...
                */}
                {userList.map((유저,index) => {    //  -> 눈에 보이게 하기 위해서 system.print.out
                    return (
                        /* key 속성 : 배열 반복 출력 시 태그를 구분하는 key */

                        <ul key={index}>
                            <li>index : {index} 번 째 유저</li>
                            <li>name  : {유저.inputName}</li>
                            <li>age   : {유저.inputAge}</li>
                        </ul>
                    )
                })

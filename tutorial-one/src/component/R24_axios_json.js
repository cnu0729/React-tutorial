    ...
    return(
        ...
        <pre>
            ...
            */}
            ...
            https://jsonplaceholder.typicode.com/ 많이 사용
            <a href='https://jsonplaceholder.typicode.com/'>jsonplaceholder이동하기</a>
            jsonplaceholder : 임시데이터로 사진이나, 포스터 내용과 같은 파일을 만들고 개발자들에게 무료 배포
            대표적으로 post, comment, albums, photo, todos, users가 존재
        ...
        npm 과 yarn 구글스토어와 애플스토어 차이 회사가 다름

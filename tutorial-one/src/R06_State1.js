...
기능에 있어 부족한 부분이 발생
그런데 class로 작성하다보니 render와 같이 불필요한 코드들을ㅇ 많이 사용하게 되었고,
다시 function으로 돌아옴
...
const State예제1 = () => {
    ...
    */
    ...
    return (
        ...
        // 그렇다면 왜 !Doctype 부터 html과 head body와 같은 태그는 사용하지 않을까?
        // public -> index.html 코드 속 <div id="root"> 라는 공간 안에
        // 우리가 만드는 javascript 와 html,css등 코드들이 모두 들어갈 것이기 떄문 
